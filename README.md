...
!(https://www.dropbox.com/s/69yzn4js9vxy112/%EC%97%B0%EB%9D%BD%ED%98%80small.png?dl=0)
...
* 1771039 윤소연 : @ysy9893 / 코드 분석(STT,Shake Detection, AndroidManifest.xml 등), tts 코드 연구(연구 자료 브랜치), 기말발표
